...
export default function About() {
   ...
   const [btnNxt,setBtnNxt]=useState('Enable Dark Mode')
   const toggleStyle =() =>{
...
<div className='container my-3'>
        <button type='button' onClick={toggleStyle} className='btn btn-primary'>{btnNxt}</button>
</div>
</div>
